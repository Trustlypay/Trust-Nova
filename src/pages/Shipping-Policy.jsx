...
const ShippingPolicy = () => {
  return (
    <div className="margin">
      ...
      <div>
        <div>
          <table className="w-fit min-w-[var(--thread-content-width)] rounded-lg border-separate">
            ...
            <tbody>
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-3 py-2 text-sm text-gray-600">Free</td>
              </tr>
              <tr className="hover:bg-gray-50">
                <td className="px-3 py-2 text-sm text-gray-600">
                ...
                <td className="px-3 py-2 text-sm text-gray-600">₹100</td>
              </tr>
              <tr className="hover:bg-gray-50">
                <td className="px-3 py-2 text-sm text-gray-600">
                  Express Shipping
              ...
              <tr className="hover:bg-gray-50">
                <td className="px-3 py-2 text-sm text-gray-600">COD Orders</td>
                <td className="px-3 py-2 text-sm text-gray-600">
                  7 business days
                </td>
                <td className="px-3 py-2 text-sm text-gray-600">₹200</td>
          ...
          <div className="sticky end-(--thread-content-margin) h-0 self-end select-none">
            <div className="absolute end-0 flex items-end">
              <span data-state="closed">
                <button className="hover:bg-token-bg-tertiary text-token-text-secondary my-1 rounded-sm p-1 transition-opacity group-[:not(:hover):not(:focus-within)]:pointer-events-none group-[:not(:hover):not(:focus-within)]:opacity-0">
                  <svg
                    width="20"
                    height="20"
                    viewbox="0 0 20 20"
