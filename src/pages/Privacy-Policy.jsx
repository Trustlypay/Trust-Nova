    ...
    <div className="margin">
      ...
      >
        ...
        >
          ...
          <p>
            Trust Nova operates this store and website, including all related
            information, content, features, tools, products and services, in
            order to provide you, the customer, with a curated shopping
            experience (the "Services"). Trust Nova is powered by Shopify, which
            enables us to provide the Services to you. This Privacy Policy
          ...
          <p>
            ...
            any of the Services, you acknowledge that you have read this Privacy
        ...
        >
          ...
          <p>
            ...
            collect or process the following categories of personal information,
            including inferences drawn from this personal information, depending
            on how you interact with the Services, where you live, and as
        ...
        >
          ...
          <ul>
            <li>
              ...
              items you are interested in, to send notifications to you related
              to your account, to process purchases, returns, exchanges or other
              transactions, to create, maintain and otherwise manage your
              account, to arrange for shipping, to facilitate any returns and
              exchanges, to enable you to post reviews, and to create a
              customized shopping experience for you, such as recommending
              products related to your purchases. This may include using your
              personal information to better tailor and improve the Services.
            </li>
            <li>
        ...
        >
          ...
          <ul>
            ...
            <li>
              ...
              you promotional emails, and you may opt out of receiving these at
          ...
          <p>
            ...
            or by contacting us using the contact details provided below. To
            learn more about how Shopify uses your personal information and any
            rights you may have, including rights related to data processed by
            Shopify, you can visit https://privacy.shopify.com/en.{" "}
          </p>
          <p>
        ...
        >
          ...
          <p>
            ...
            transfer is to a country that has been determined to provide an
        ...
        >
          ...
          <p>
            ...
            website, update the "Last updated" date and provide notice as
        ...
        >
          ...
          <p>
            ...
            available to you, please call or email us at info@trustnova.shop or
            contact us at Plot No 4/2, Sector 1, Madhapur, HUDA Techno Enclave,
            HITEC City, HUDA Techno Enclave, Hyderabad, TS, 500081, IN{" "}
          </p>
        </div>
      </div>
    </div>
